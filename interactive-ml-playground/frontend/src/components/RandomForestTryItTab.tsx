...
import { apiClient, DataUploadResponse, RandomForestTrainResponse } from "@/lib/api";
...
export default function RandomForestTryItTab() {
  ...
  // Results state
  const [trainResult, setTrainResult] = useState<RandomForestTrainResponse | null>(null);
  ...
  const handleTrain = async () => {
    ...
    try {
      ...
      const result = await apiClient.trainRandomForest(
        data,
        selectedFeatures,
        targetColumn,
        nEstimators,
        ...
        <div className="bg-terminal-panel border-2 border-terminal-black p-6">
          ...
          <div className="mt-6 p-4 bg-terminal-black text-terminal-mint">
            <p className="font-mono text-xs">
              <span className="text-terminal-accent font-bold">TIP:</span> RANDOM FOREST COMBINES MULTIPLE DECISION TREES FOR BETTER ACCURACY.
          ...
          <div className="bg-terminal-accent/20 border-2 border-terminal-accent p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-xs text-terminal-black/70">
                N_TREES={trainResult.metrics.n_estimators} | {trainResult.metrics.n_classes} CLASSES
              </p>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="border-2 border-terminal-black p-4">
                      <div className="text-xl font-bold text-terminal-black">
                        {trainResult.metrics.n_estimators}
                      </div>
                      <div className="font-mono text-xs text-terminal-black/70 uppercase">NUMBER OF TREES</div>
                    </div>
                    <div className="border-2 border-terminal-black p-4">
                      <div className="text-xl font-bold text-terminal-black">
                        {trainResult.metrics.max_depth ?? "∞"}
                      </div>
                      <div className="font-mono text-xs text-terminal-black/70 uppercase">MAX DEPTH</div>
                    </div>
                    <div className="border-2 border-terminal-black p-4">
                      <div className="text-xl font-bold text-terminal-black">
