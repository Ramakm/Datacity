...
class DecisionTreeTrainer:
    """Handles training and prediction for Decision Tree models."""
    ...
    def train(
        ...
        metrics = {
            ...
            "max_depth": max_depth if max_depth else self.model.get_depth(),
        ...
        generated_code = self._generate_code(feature_columns, target_column, max_depth, min_samples_split, test_size)
    ...
    def predict(
        ...
        Note: For new predictions, we need to retrain the model with stored parameters.
        """
        df = pd.DataFrame(data)
        predictions = []
